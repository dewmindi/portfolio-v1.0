...
// Scroll-triggered reveal: fades/slides its children in when they enter view.
function Reveal({
  children,
  delay = 0,
  className = "",
        ...
        <div className="space-y-8 text-white">
          <Reveal>
            <p className="text-3xl md:text-[2.6rem] font-bold leading-[1.12] tracking-tight">
              Our approach at DewMindi is designed to make your journey from
          ...
          <Reveal delay={0.1}>
            <p className="text-3xl md:text-[2.6rem] font-bold leading-[1.12] tracking-tight">
              ...
              and your unique vision. At every step, we&apos;ll keep you
